    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-info">Select survey to send:</div>
                    <div class="panel-body">
                        <select class="form-control" >
                            <option>Middle aged men's preference of cars</option>
                            <option>Children between ages 8-16 and spicy foods</option>
                            <option>Student Backgrounds and their choice of majors</option>
                        </select>
                    </div>
                </div>
